...
from analitica.aplicacion.servicios import evaluacion_ocurrencia_v3 as service
from analitica.aplicacion.servicios import replay
from analitica.interfaces.scripts import evaluar_ocurrencia_v3 as facade
