...
def _torneo(args, tipo: str):
    from ...aplicacion.procesos.backtest import construir_backtest
    from ...aplicacion.procesos.engine import (
        ProjectionConfig,
        ProjectionScenario,
    ...
    from ...dominio.evaluacion.calidad import (
    ...
    from ...dominio.evaluacion.metricas import metricas_pareadas_modelos
    from ...dominio.evaluacion.reconciliacion import bottom_up
    from ...dominio.modelos.challengers import entrenar_challengers_finales
    from ...dominio.modelos.fenologico import construir_panel_fenologico, proyectar_fenologico_v1
    from ...dominio.modelos.hibrido import proyectar_hibrido_v1
    from ...infraestructura.clima import AdaptadorOpenMeteo
    from ...infraestructura.fuentes import cargar_datos
    from ...infraestructura.persistencia import (
        log_metricas_mlflow,
        registrar_modelos_mlflow,
        tracking_mlflow,
    )
    from ...interfaces.exportacion import exportar_paquete
    from ...interfaces.interpretabilidad import paquete_interpretabilidad_xgboost
...
def ejecutar_project(args) -> int:
    from ...dominio.evaluacion.calidad import controles_reconciliacion
    from ...dominio.evaluacion.reconciliacion import bottom_up
