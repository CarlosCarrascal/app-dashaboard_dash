...
def ejecutar_relaciones(args) -> int:
    from ...dominio.evaluacion.calidad import controles_ensamblaje, controles_fuente
    from ...dominio.evaluacion.inferencia import evaluar_matriz_inferencial
    from ...dominio.evaluacion.relaciones_partes import (
    ...
    from ...infraestructura.persistencia import tracking_mlflow
