...
def ejecutar_validar_operativo(args) -> int:
    ...
    from ...aplicacion.operativo import seleccionar_libros_operativos, validar_libro_operativo
    from ...infraestructura.persistencia import RepositorioAnalytics
...
def ejecutar_project_operativo(args) -> int:
    ...
    from ...aplicacion.operativo import (
        MODELO_OPERATIVO_ACTUAL,
        construir_modelo_operativo_excel,
        datos_proyeccion_operativo,
    )
    from ...infraestructura.persistencia import RepositorioAnalytics, tracking_mlflow
