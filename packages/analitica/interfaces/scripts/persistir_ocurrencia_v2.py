...
La lógica reusable vive en :mod:`analitica.aplicacion.servicios.persistir_ocurrencia_v2`.
"""
...
from analitica.aplicacion.servicios import persistir_ocurrencia_v2 as _servicio
