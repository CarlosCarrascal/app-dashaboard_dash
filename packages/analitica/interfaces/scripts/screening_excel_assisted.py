...
La implementación de negocio vive en :mod:`analitica.aplicacion.servicios.excel_assisted`.
...
from analitica.aplicacion.servicios import excel_assisted as _servicio
