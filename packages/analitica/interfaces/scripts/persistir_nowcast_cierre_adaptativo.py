...
:mod:`analitica.aplicacion.servicios.persistir_nowcast_cierre_adaptativo`.
...
from analitica.aplicacion.servicios import persistir_nowcast_cierre_adaptativo as _servicio
