...
La lógica reusable vive en :mod:`analitica.aplicacion.servicios.buscar_candidatos_replay`.
...
from analitica.aplicacion.servicios import buscar_candidatos_replay as _servicio
