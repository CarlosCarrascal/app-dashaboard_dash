...
La lógica reutilizable vive en :mod:`analitica.aplicacion.servicios.screening_turno_reingreso`.
...
from analitica.aplicacion.servicios import screening_turno_reingreso as _servicio
