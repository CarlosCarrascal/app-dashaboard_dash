...
La lógica reusable vive en :mod:`analitica.aplicacion.servicios.certificar_releases_replay`.
Este módulo conserva aliases públicos/privados, firmas, CLI y serialización histórica.
"""

from __future__ import annotations

from analitica.aplicacion.servicios import certificar_releases_replay as _servicio
