...
La lógica reusable vive en :mod:`analitica.aplicacion.servicios.persistir_hibrido_parametros_asof`.
...
from analitica.aplicacion.servicios import persistir_hibrido_parametros_asof as _servicio
