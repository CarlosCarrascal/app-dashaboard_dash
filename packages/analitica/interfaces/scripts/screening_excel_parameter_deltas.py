...
La lógica de negocio vive en :mod:`analitica.aplicacion.servicios.excel_parameter_deltas`.
...
from analitica.aplicacion.servicios import excel_parameter_deltas as _servicio
