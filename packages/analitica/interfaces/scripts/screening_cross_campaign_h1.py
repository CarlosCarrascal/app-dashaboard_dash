...
La implementación de negocio vive en :mod:`analitica.aplicacion.servicios.cross_campaign`.
...
from analitica.aplicacion.servicios import cross_campaign as _cross_campaign
