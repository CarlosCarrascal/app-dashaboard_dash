"""API del proceso de candidatos, separada por responsabilidad.

Los candidatos son una evaluación temporal no persistible: sus contratos, cache,
fuentes, preflight, snapshots y transformaciones de turno viven en módulos hermanos.
"""
...
from .turno_temporal_contratos import CLAVE_FORECAST, CLAVE_UNIVERSO, ConfiguracionTurnoTemporal
