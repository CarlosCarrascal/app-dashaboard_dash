...
La lógica reusable vive en :mod:`analitica.servicios.persistir_ocurrencia_universo`.
...
from analitica.servicios import persistir_ocurrencia_universo as _servicio
