...
La lógica de negocio vive en :mod:`analitica.servicios.lagged_parameters_horizons`.
...
from analitica.servicios import lagged_parameters_horizons as _servicio
