...
La lógica reusable vive en :mod:`analitica.servicios.diagnostico_nowcast_horizontes`.
...
from analitica.servicios import diagnostico_nowcast_horizontes as _servicio
