...
from . import clima
from .datos import Hallazgo, Panel, cargar_panel, diagnostico_ventanas
...
from .informe import construir as construir_informe
from .modelo import Ajuste, Consistencia, entrenar, verificar_consistencia
