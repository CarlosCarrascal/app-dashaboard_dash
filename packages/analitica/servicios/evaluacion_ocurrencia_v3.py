...
La fachada histórica en :mod:`analitica.scripts.evaluar_ocurrencia_v3` conserva
...
from analitica.servicios.replay import emisiones_completas, normalizar_modelo
