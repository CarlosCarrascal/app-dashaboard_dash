...
if TYPE_CHECKING:
    from ..nucleo.bhattacharya import (
...
def __getattr__(nombre: str):
    ...
    if nombre in _SIMBOLOS_BHATTACHARYA:
        modulo = importlib.import_module("..nucleo.bhattacharya", __package__)
...
def _calibrar_grupo_db(
    ...
    from ..nucleo.bhattacharya import ajustar_lote_automatico
...
def generar_proyeccion_empresa(
    ...
    from ..nucleo.bhattacharya import proyectar_curva_oleadas
