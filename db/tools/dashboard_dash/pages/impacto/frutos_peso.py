"""Página «Frutos y peso» — puerto completo de `dashboard/vistas/clima.py::_frutos_peso`
(incluye `_floracion` y `_desfases_conjunto`) y de `dashboard/vistas/conclusiones.py::
...
import nucleo
from config import AZUL, GRIS, ROJO, etiqueta
