...
COMMENT ON COLUMN raw.h02_bd_elifab.calibre IS
    ...
    'son la misma palabra con dos grafías y se unifican al cargar core.m_calibre; "Defectos" y '
...
COMMENT ON COLUMN raw.h02_bd_elifab.calibres IS
    ...
    'trazabilidad y NO se usa para cargar core.m_calibre: [Calibre] es la fuente granular real.';
